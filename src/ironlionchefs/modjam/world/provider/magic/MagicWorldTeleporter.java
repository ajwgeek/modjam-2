...
public class MagicWorldTeleporter extends Teleporter
{
	...
	public MagicWorldTeleporter(WorldServer par1WorldServer)
	{
	...
	public void placeInPortal(Entity par1Entity, double par2, double par4, double par6, float par8)
	{
		...
		else
		{
			...
			this.worldServerInstance.setBlock(i, j, k, ModJam.potionCauldron.blockID);
	...
	public boolean placeInExistingPortal(Entity par1Entity, double par2, double par4, double par6, float par8)
	{
		...
		else
		{
			for (k1 = l - short1; k1 <= l + short1; ++k1)
			{
				...
				for (int l1 = i1 - short1; l1 <= i1 + short1; ++l1)
				{
					...
					{
						if (this.worldServerInstance.getBlockId(k1, i2, l1) == ModJam.potionCauldron.blockID)
						{
							while (this.worldServerInstance.getBlockId(k1, i2 - 1, l1) == ModJam.potionCauldron.blockID)
							{
								--i2;
							}
		...
		if (d3 >= 0.0D)
		{
			if (flag)
			{
				this.destinationCoordinateCache.add(j1, new MagicPortalPosition(this, i, j, k, this.worldServerInstance.getTotalWorldTime()));
			...
			d4 = (double) k + 0.5D;
			int j2 = -1;
			if (this.worldServerInstance.getBlockId(i - 1, j, k) == ModJam.potionCauldron.blockID)
			{
				j2 = 2;
			}
			if (this.worldServerInstance.getBlockId(i + 1, j, k) == ModJam.potionCauldron.blockID)
			...
			if (this.worldServerInstance.getBlockId(i, j, k - 1) == ModJam.potionCauldron.blockID)
			{
				j2 = 3;
			}
			if (this.worldServerInstance.getBlockId(i, j, k + 1) == ModJam.potionCauldron.blockID)
	...
	public boolean makePortal(Entity par1Entity)
	{
		...
		this.worldServerInstance.setBlock(k3, j3, i4, ModJam.potionCauldron.blockID, 0, 2);
		return true;
	}
