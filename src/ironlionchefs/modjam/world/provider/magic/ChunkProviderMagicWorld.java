...
public class ChunkProviderMagicWorld implements IChunkProvider
{
	private Random rand;
	...
	public ChunkProviderMagicWorld(World par1World, long par2, boolean par4)
	{
			...
			for (int var9 = 0; var9 < 16; var9++)
			{
				...
				for (int var16 = 127; var16 >= 0; var16--)
				{
					...
					else
					{
						...
						else if (var18 != ModJam.blockNewDimGrass.blockID)
						{
							if (var13 == -1)
							{
								if (var12 == 0)
							...
							else if (var13 > 0)
							{
								var13--;
								par3ArrayOfByte[var17] = var15;
								if ((var13 == 0) && (var15 == Block.stone.blockID))
								{
