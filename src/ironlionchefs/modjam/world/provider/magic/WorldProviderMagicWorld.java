...
public class WorldProviderMagicWorld extends WorldProvider
{
	...
	{
		return new ChunkProviderMagicWorld(this.worldObj, this.worldObj.getSeed(), false);
	}
	...
	{
		if ((this instanceof WorldProviderMagicWorld))
		{
			return "Entering the Magic World";
		}
		return null;
	}
