...
public class MagicLowOreGenerator implements IWorldGenerator
{
	...
	public void generateSurface(World world, Random random, int chunkX, int chunkZ)
	{
		for (int i = 0; i < 8; i ++)
		{
			...
			new WorldGenMinable(ModJam.essenceLowOreOverworld.blockID, 8).generate(world, random, randPosX, randPosY, randPosZ);
		}
	}
