...
public class BlockLeavesMagic extends BlockLeavesBase implements IShearable
{
    int[] adjacentTreeBlocks;

    public BlockLeavesMagic(int par1)
    {
    ...
    {
       this.blockIcon = par1IconRegister.registerIcon("ModJam:leaves_magic");
    }
