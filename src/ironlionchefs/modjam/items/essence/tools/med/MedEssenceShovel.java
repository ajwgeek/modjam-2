...
public class MedEssenceShovel extends ItemSpade
{

	public MedEssenceShovel(int par1)
	{
	...
	{
		this.itemIcon = register.registerIcon("ModJam:MedEssenceShovel");
		this.setUnlocalizedName("Normal Essence Shovel");
	}
}