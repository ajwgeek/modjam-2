...
public class LowEssenceHoe extends ItemHoe
{

	public LowEssenceHoe(int par1)
	{
	...
	{
		this.itemIcon = register.registerIcon("ModJam:LowEssenceHoe");
		this.setUnlocalizedName("Weak Essence Hoe");
	}
}