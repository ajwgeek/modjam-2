...
public class LowEssenceAxe extends ItemAxe
{

	public LowEssenceAxe(int par1)
	{
	...
	{
		this.itemIcon = register.registerIcon("ModJam:LowEssenceAxe");
		this.setUnlocalizedName("Weak Essence Axe");
	}
}