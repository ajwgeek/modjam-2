...
public class HighEssenceHelmet extends ItemArmor
{

	public HighEssenceHelmet(int par1)
	{
	...
	public void onCreated(ItemStack is, World w, EntityPlayer ep)
	{
		...
		is.addEnchantment(Enchantment.respiration, 3);
	...
	{
		this.itemIcon = register.registerIcon("ModJam:HighEssenceHelm");
		this.setUnlocalizedName("Potent Essence Helmet");
	}
}
