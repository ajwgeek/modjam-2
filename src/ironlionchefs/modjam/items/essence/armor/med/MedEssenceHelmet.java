...
public class MedEssenceHelmet extends ItemArmor
{
	...
	{
		this.itemIcon = register.registerIcon("ModJam:MedEssenceHelm");
		this.setUnlocalizedName("Regular Essence Helmet");
	}
}