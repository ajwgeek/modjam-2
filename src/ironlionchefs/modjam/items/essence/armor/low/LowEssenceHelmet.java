...
public class LowEssenceHelmet extends ItemArmor
{

	public LowEssenceHelmet(int par1)
	{
	...
	{
		this.itemIcon = register.registerIcon("ModJam:LowEssenceHelm");
		this.setUnlocalizedName("Weak Essence Helmet");
	}
}