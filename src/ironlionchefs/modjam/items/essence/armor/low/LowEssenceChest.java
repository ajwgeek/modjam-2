...
public class LowEssenceChest extends ItemArmor
{

	public LowEssenceChest(int par1)
	{
	...
	{
		this.itemIcon = register.registerIcon("ModJam:LowEssenceChest");
		this.setUnlocalizedName("Weak Essence Chestplate");
	}
}